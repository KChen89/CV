...
- Under review of in preparation 
  - K.Chen, LS Powers, JM Roveda, Deep Learning based Multi-Sensor Signal Fusion For Neurological Activity Estimation. (submitted to IEEE/ACM Transactions on Computational Biology and Bioinformatics). </br>
